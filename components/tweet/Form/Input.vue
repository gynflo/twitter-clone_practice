...
// *** Computed ***
const isDisabled = computed(() => text.value.length < 5);

// *** Fonction ***
function handleClick() {
  imageInput.value.click(); // Faire apparaitre la modal du choix de fichiers
}
...
function handleImageChange(event) {
  ...
  //Indique visuellement l'image chargée
...
<template>
  <div>
    <!-- Flex-shrink-0 => Empêche l'élément flexible de rétrécir-->
    ...
    <div class="p-4 pl-16">
      <img
        ...
        alt=""
        v-if="inputImageUrl"
        class="w-50 h-40 rounded-2xl border"
    ...
    <div class="flex p-2 pl-14">
      <div class="flex justify-between w-full">
        ...
        <div class="flex">
          <!-- Image frame Icon -->
          <div
            class="p-2 text-blue-400 rounded-full hover:bg-blue-500 cursor-pointer hover:text-white dark:hover:bg-dim-800"
            @click="handleClick"
          >
